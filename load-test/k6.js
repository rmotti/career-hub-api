...
export const options = {
  ...
  thresholds: {
    ...
    list_saves_duration:          ['p(95)<2000'],
    create_save_duration:         ['p(95)<1500'],
    list_players_duration:        ['p(95)<2500'],
    create_player_duration:       ['p(95)<2000'],
    update_player_duration:       ['p(95)<2000'],
    update_player_stats_duration: ['p(95)<2000'],
    transfer_duration:            ['p(95)<2000'],
    advance_season_duration:      ['p(95)<2500'],
    change_club_duration:         ['p(95)<2500'],
    team_stats_duration:          ['p(95)<2000'],
    trophy_duration:              ['p(95)<2500'],
  },
}
